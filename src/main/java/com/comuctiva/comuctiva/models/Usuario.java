...
public class Usuario {
    ...
    public List<Rol_Usuario> getRoles_de_usuarios() {
        return roles_de_usuarios;
    }
    public void setRoles_de_usuarios(List<Rol_Usuario> roles_de_usuarios) {
        this.roles_de_usuarios = roles_de_usuarios;
    }
}
